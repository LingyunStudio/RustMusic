      ...
      <div className="flex flex-col gap-4 max-w-[760px]">
        ...
        <section style={{ ["--row-idx" as string]: 5 }} className="anim-row glass rounded-2xl p-5">
          ...
          <p className="text-[11.5px] text-[var(--ink-3)] mt-2 leading-relaxed">
            ...
            音量混音器：采样率按源文件直通输出，不经系统重采样与音效处理，尽可能保留原始音质。注意：独占播放期间其它应用将暂时无法发声；若声卡不支持当前采样率或系统禁用了独占授权，该曲目会自动回退普通模式播放；均衡器与音量在独占模式下仍有效；开启后下一首生效，关闭则立即切回普通模式（从当前进度继续播放，其它应用恢复出声）。
          </p>
        </section>
